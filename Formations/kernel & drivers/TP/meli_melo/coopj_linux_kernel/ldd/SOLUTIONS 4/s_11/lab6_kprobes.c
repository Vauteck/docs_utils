...
static void __exit my_exit(void)
{
...
#endif
	printk(KERN_INFO "\n\n FINAL STATISTICS:\n\n");
	printk(KERN_INFO "count_add_timer = %d\n", count_add_timer);
	printk(KERN_INFO "count_mod_timer = %d\n", count_mod_timer);
	printk(KERN_INFO "Totals add+mod = %d\n",
	...
	printk(KERN_INFO "Totals dels= %d\n",
...
MODULE_DESCRIPTION(""":1.0 s_11/lab6_kprobes.c");

 ...
 *
 * Note: This is not an easy exercise to do properly, so if time is
 * lacking you may merely experiment with the solutions.
 @*/
...
/*
 *  mycdrv_ioctl() --- give the user the value ramdisk_size
 */
static int
mycdrv_ioctl (struct inode *ino, struct file *filp,
...
MODULE_DESCRIPTION ("CLDD:1.0 s_18/lab3_mmap.c");

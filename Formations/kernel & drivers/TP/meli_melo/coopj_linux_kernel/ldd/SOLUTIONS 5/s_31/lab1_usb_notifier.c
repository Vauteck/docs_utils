/* **************** CLDD:1.0 s_31/lab1_usb_notifier.c **************** */
/*
                             ...
                             void *data)
{
    ...
    switch (event) {
    case USB_DEVICE_ADD:
        printk (KERN_INFO "Adding a USB device, event=USB_DEVICE_ADD\n");
        break;
    case USB_DEVICE_REMOVE:
        printk (KERN_INFO "Removing a USB device, event=USB_DEVICE_REMOVE\n");
        break;
    case USB_BUS_ADD:
        printk (KERN_INFO "Adding a USB bus, event=USB_BUS_ADD\n");
        break;
    case USB_BUS_REMOVE:
        printk (KERN_INFO "Removing a USB bus, event=USB_BUS_REMOVE\n");
        break;
    default:
        printk (KERN_INFO "Receiving an unknown USB event\n");
        break;
    }
...
MODULE_DESCRIPTION ("CLDD:1.0 s_31/lab1_usb_notifier.c");

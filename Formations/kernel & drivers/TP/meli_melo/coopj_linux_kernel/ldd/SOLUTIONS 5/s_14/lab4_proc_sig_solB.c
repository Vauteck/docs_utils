/* **************** CLDD:1.0 s_14/lab4_proc_sig_solB.c **************** */
/*
                ...
                unsigned long count, void *data)
{
    ...
    printk (KERN_INFO "sig_pid has been set to %d\n", sig_pid);
                ...
                unsigned long count, void *data)
{
    ...
    printk (KERN_INFO "sig_tosend has been set to %d\n", sig_tosend);
    if (!sig_tsk) {
...
MODULE_DESCRIPTION ("CLDD:1.0 s_14/lab4_proc_sig_solB.c");

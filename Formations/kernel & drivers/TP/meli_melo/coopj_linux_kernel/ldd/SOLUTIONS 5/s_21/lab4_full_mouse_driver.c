/* **************** CLDD:1.0 s_21/lab4_full_mouse_driver.c **************** */
/*
...
/*
 * Copyright Jerry Cooperstein (GPLv2) (12/2002) (coop@coopj.com)
...
{
    send_sig (SIGIO,
              pid_task (find_vpid(user_pid),PIDTYPE_PID), 1);
               ...
               loff_t * ppos)
{
    /* in case we want to turn on a real write:
       int r;
       char byte;
       printk (KERN_INFO " Entering the WRITE function, shouldn't be here\n");
       for (r = 3; r < lbuf; r++) {
       get_user (byte, buf + r);
...
static int __init my_init (void)
{
    ...
    device_create (mymouse_class, NULL, first, "%s", "mymouse");
...
MODULE_DESCRIPTION ("CLDD:1.0 s_21/lab4_full_mouse_driver.c");

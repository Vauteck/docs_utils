...
{
    printk (KERN_INFO "Hello world from mymod\n");
    mod_fun ();
    return 0;
}
...
{
    printk (KERN_INFO "Goodbye world from mymod\n");
}
...
MODULE_DESCRIPTION ("CLDD:1.0 s_09/lab3_module2.c");
